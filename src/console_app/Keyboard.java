package console_app;/*
 * CompSci 101 - ictgradschool.industry.assgn03.Keyboard Class
 * ============================
 ...
 * Example usage:
 *
 * String input = ictgradschool.industry.assgn03.Keyboard.readInput();
 *
...
public class Keyboard {
    ...
    public static String readInput() {
        ...
        try {
            ...
            System.err.println("An error has occurred in the ictgradschool.industry.assgn03.Keyboard constructor.");
            e.printStackTrace();
            System.exit(-1);
        }
        ...
        try {
            ...
            System.err.println("An error has occurred in the ictgradschool.industry.assgn03.Keyboard.readInput() method.");
            e.printStackTrace();
            System.exit(-1);
        }
        return null;
